<?php
session_start();
include_once "Controller/full_student_controller.php";
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">New Student Registration Form</h2>

                    <form method="POST">
                        <input type="hidden" name="stu_nrc" value="<?php echo $_SESSION['register_array']['student_nrc'] ?>">
                        <!--Student INfo-->
                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="p-t-15">
                                    <button class="btn btn--radius-2 btn--blue" type="submit" name="new_student_register">Register</button>
                                </div>
                            </div>
