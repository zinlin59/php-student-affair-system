    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">New Student Add Form</h2>
                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="p-t-15">
                                    <button class="btn btn--radius-2 btn--blue" type="submit" name="new_student_register">Add Student</button>
                                </div>
                            </div>
                            <div class="col-2" style="margin-top: 20px;">
                                <a href="students_list.php" class="btn">
                                    << Back</a>
                            </div>
                        </div>
                    </form>
