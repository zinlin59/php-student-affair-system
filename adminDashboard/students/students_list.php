<?php
require "studentController/student_list_controller.php";
?>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="">
                        <a href="/student_affair_system/adminDashboard/admin/admin_dashboard.php"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="students/students_list.php">Students List</a></li>
  ...
  text-shadow: 1px 1px 2px black, 0 0 25px purple, 0 0 5px purple;">ADMIN
    ...
    --> Student Information
                                            <button type="submit" class="btn btn-otline-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-csv" viewBox="0 0 16 16">
                                        ...
                                        <div class="row ">
                                            <div class="col-8">
                                                ...
                                                <form class="" action="/action_page.php">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <select id="naing" name="naing" class="form-select" placeholder="N" style="width: 150px;">
                                                                <option value="N" selected>Name</option>
                                                                <option value="P">NRC</option>
    ...
    -->
                                            ...
                                            <div class="col-4">
                                                <a href="add_student_list.php"><button type="submit" class="btn btn-success f-right "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        ...
                                        <tbody id="myTable">
                                            <?php while ($res = $result->fetch_assoc()) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $res['student_nrc'] ?></td>
                                                    <td><?php echo $res['gender'] ?></td>
                                                    <td><?php echo $res['student_phone_no'] ?></td>
                                                    <td>
                                                        <a href="studentList_moreinfo.php?more_stuid=<?php echo $res['id'] ?>"><button type="submit" class="view_data btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                                    <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
                                                                    <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
                                                                </svg>&nbsp;&nbsp;Info</button></a>
                                                        <a href="edit_student_list.php?stuid=<?php echo $res['id'] ?>">
                                                        ...
                                                        <a href="students_list.php? delete_user=<?php echo $res['id']; ?>" onclick="return confirm('Are you sure you want to delete this student ?')" class="btn btn-danger">
                ...
                <div class="footer-inner bg-white">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            Designed by <a href="https://colorlib.com">Zin Lin Htike</a>
                        </div>
                    </div>
                </div>
            </footer>
