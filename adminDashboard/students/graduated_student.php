<?php
require "studentController/graduated_student_controller.php";
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9 p-5px">
                                        <div class="row ">
                                            ...
                                            <div class="col-4">
                                                <a href="#"><button type="submit" class="btn btn-success f-right ">
                                                        </svg>&nbsp; &nbsp; Graduate Student</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="table-stats order-table ov-h">
                                            <table class="table ">
                                                ...
                                                <tbody id="myTable">
                                                    ...
                                                    <?php foreach ($student_result as $stu_res) { ?>
                                                        <tr>
