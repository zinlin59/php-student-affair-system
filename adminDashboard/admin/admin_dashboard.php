                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="/student_affair_system/adminDashboard/students/students_list.php">Students List</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="/student_affair_system/adminDashboard/students/admitted_students.php">Admitted Students</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="/student_affair_system/adminDashboard/students/graduated_student.php">Graduated Students</a></li>
                        </ul>
                    </li>
                    <!--
                    <li class="menu-item-has-children dropdown">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <!--   <input type="number" class="form-control" style="width: 70px;" placeholder="<?php echo $count_pending_stu ?>">
    -->
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td> <a href="/student_affair_system/adminDashboard/padding_student_moreinfo.php?more_stuid=<?php echo $row['id'] ?>"><button type="submit" class="view_data btn btn-primary">More info</button></a></td>
