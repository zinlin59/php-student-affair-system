...
if (isset($_GET['more_stuid'])) {
    ...
    if (mysqli_num_rows($getdata) == 1) {
        foreach ($getdata as $getdatas) {
            ...
            $getsubject = $getdatas['specialized_subject'];
                    ...
                    <div class="tab-pane profile active" id="profile-tab">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="data-row">
                                    <span class="data-name">Subject</span>
                                    <span class="data-value"><?php echo $getsubject ?></span>
                                </p>
                                <p class="data-row">
                        ...
                        <form action="" method="post">
                            <div class="row">
                                <button type="submit" class="btn btn-primary" name="btn_access">
                                    << Back </button>
                                        </a>
