                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="students/admitted_students.php">Admitted Students</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="students/graduated_student.php">Graduated Students</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                ...
                <div class="navbar-header">
                    <div class="row">
                        ...
                        <div class="col-5 pt-3 text-success b">
                            <div class="text-success b">ADMIN</div>
                        </div>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa- user"></i><?php echo $_SESSION['user_array']['student_name'] ?></a>
